...
public class formUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sikare/Sikare/KasirRestoran/src/com/restoran/gambar/me_as_colonel_sanders__kfc_logo__refaced__by_allampanato-d5wdcom2.jpg"))); // NOI18N
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 510));

        getContentPane().add(jPanel1, "card3");

        makanan.setBackground(new java.awt.Color(255, 153, 153));
